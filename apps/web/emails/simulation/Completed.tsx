...
export const SimulationCompletedEmail = ({
  email,
  firstName,
  platformURL,
}: Props) => {
      ...
      <Tailwind>
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              your simulation has been successfully completed. You can view
              details and download artifacts at the platform.
            </Text>
...
SimulationCompletedEmail.PreviewProps = {
  email: "john@doe.com",
  firstName: "John",
  platformURL: "https://localhost:3000",
} as Props;

export default SimulationCompletedEmail;
