...
export const SimulationErroredEmail = ({
  email,
  firstName,
  platformURL,
}: Props) => {
  const previewText = `You left a simulation in our hands...`;
        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">
              Your simulation has ended (and that&apos;s bad).
            </Heading>
            <Text className="text-black text-[14px] leading-[24px]">
              Hello {firstName},
            </Text>
            <Text className="text-black text-[14px] leading-[24px]">
              Your simulation has ended. Unfortunately, something went wrong
              with it. You can access the platform to download logs and view the
              error generated by your run.
            </Text>
            <Text className="text-black text-[14px] leading-[24px]">
              We hope that this does not discourage you in simulating, and we
              are always ready for your next simulation.
            </Text>
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              ...
              <Link href={platformURL} className="text-blue-600 no-underline">
                {platformURL}
              </Link>
            </Text>
...
SimulationErroredEmail.PreviewProps = {
  email: "john@doe.com",
  firstName: "John",
  platformURL: "https://localhost:3000",
} as Props;

export default SimulationErroredEmail;
