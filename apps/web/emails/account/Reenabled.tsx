...
export const AccountReenabledEmail = ({ email, firstName }: Props) => {
  const previewText = `About your account.`;
      ...
      <Tailwind>
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              your account at <strong>LABIOQUIM</strong> has been re-enabled.
            </Text>
...
AccountReenabledEmail.PreviewProps = {
  email: "john@doe.com",
  firstName: "John",
} as Props;
